...
void matrixMulCPU(double *C, const double *A, const double *B, unsigned int hA, unsigned int wA, unsigned int wB)
{
...
int main()
{
    ...
    {
        matrixMulCPU(h_C, h_A, h_B, matrix_size.hA, matrix_size.wA, matrix_size.wB);
    }
